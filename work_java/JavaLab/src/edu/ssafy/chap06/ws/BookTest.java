...
public class BookTest {
	...
	public static void main(String[] args) {
		...
		b.add(new Magazine(44444, "Java World", "heesu", "Jaen", 7000, "first",2019, 2));
		b.add(new Magazine(35535, "Java World", "heesu", "hee", 7000, "first",2019, 2));
		b.add(new Magazine(35535, "Java World", "heesu", "su", 7000, "first",2019, 2));
		...
		System.out.println("올해 모든 잡지를 출력합니다");
		b.searchThisYearM();
